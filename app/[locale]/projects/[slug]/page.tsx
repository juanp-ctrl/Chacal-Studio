...
export default async function ProjectDetailPage() {
  ...
  return (
    <>
      ...
      <div className="absolute top-24 left-0 right-0 z-40 px-6 sm:px-8 lg:px-12">
        ...
        <div className="py-24 sm:py-32 bg-background">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="relative overflow-hidden rounded-3xl aspect-4/3 bg-secondary">
      ...
      {(localizedSolution || localizedDescription) && (
        <div className="py-24 sm:py-32 bg-primary text-white">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            {project.images && project.images.length > 1 && project.images[1] && (
      ...
      {project.images && project.images.length > 2 && (
        <div className="py-24 sm:py-32 bg-background">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <Heading as="h2" className="text-primary mb-16 font-bold text-3xl sm:text-4xl md:text-5xl font-heading">
              {t('gallery')}
            </Heading>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
              {project.images.slice(2).map((image, index) => (
                <div key={index} className="relative overflow-hidden rounded-2xl aspect-4/3 bg-secondary group">
                  <Image
                    src={image}
            ...
            <div className="max-w-7xl mx-auto">
              <div>
                ...
                <div className="flex items-center gap-6 mb-6">
                  ...
                  <ArrowRight
                    size={48}
                    className="shrink-0 text-white group-hover:text-accent group-hover:translate-x-2 transition-all duration-300"
                  />
                </div>
