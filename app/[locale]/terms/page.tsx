      ...
      <div className="min-h-screen bg-(--brand-blue)">
        ...
        <section className="px-6 pb-24 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-4xl">
            <div className="bg-background space-y-12 rounded-2xl p-8 shadow-lg sm:p-12">
              {/* ==================== TERMS OF SERVICE ==================== */}
              ...
              <PolicySection title={t('userConduct.title')}>
                ...
                <ul className="text-foreground/90 ml-6 list-outside list-disc space-y-2">
                  <li>
                    <Text as="span">{t('userConduct.items.lawful')}</Text>
                  </li>
                  <li>
                    <Text as="span">{t('userConduct.items.noHarm')}</Text>
                  </li>
                  <li>
                    <Text as="span">{t('userConduct.items.noMalware')}</Text>
                  </li>
                  <li>
                    <Text as="span">{t('userConduct.items.noUnauthorized')}</Text>
                  </li>
                </ul>
              </PolicySection>
              ...
              <div className="border-accent/30 border-t-2 pt-8">
  ...
  return (
    <section>
      <Heading
        ...
        className={`text-foreground mb-4 border-b pb-2 ${isSubsection ? 'border-border/50' : 'border-border'}`}
      >
        {title}
      </Heading>
      {children}
...
function CookieTypeItem({ title, description }: { title: string; description: string }) {
  return (
