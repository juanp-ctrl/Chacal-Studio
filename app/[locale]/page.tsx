...
export default async function Home({ params }: PageProps) {
  ...
  const organizationJsonLd = {
    ...
    serviceType: [
      ...
      locale === 'es' ? 'Asesoría comunicacional' : 'Communication advisory',
      locale === 'es' ? 'Diagnóstico comunicacional' : 'Communication diagnosis',
      locale === 'es' ? 'Gestión de la comunicación' : 'Communication management',
      locale === 'es' ? 'Consultoría Sustentable' : 'Sustainability Consulting',
    ],
  };
